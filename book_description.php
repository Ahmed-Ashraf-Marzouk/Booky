...
<body class="max-width-body bg-color">
  ...
  <div class="book-card">
    <div class="image-container">
      <div class="image-background">
        <img class="image" src="media/jpg/book-cover-book-description.jpeg" alt="" />
      </div>
    </div>
    <div class="side-content">
      ...
      <div class="decription-container">
        <p class="book-description">
          ...
          nam possimus eius! Dolores doloremque provident doloribus corrupti
          pariatur harum nisi iusto sed, illo nihil, nulla totam quae
          voluptate iste. Ipsa? Fugiat, placeat. Quas neque aliquid sed
          aliquam omnis modi natus dolorem dicta distinctio, maxime culpa esse
          doloribus quos doloremque harum molestiae nam qui nostrum,
          laudantium beatae amet quaerat praesentium delectus. Unde ad impedit
          iure possimus aut dicta dolorum nesciunt? Eius voluptates hic
          temporibus eaque illum dolorum reprehenderit, obcaecati rem
          molestiae nulla ipsa, odio cum totam dolore et. Error, dolorum
          pariatur. Doloremque, ipsum? Quaerat mollitia numquam provident!
          Deserunt maxime tempora necessitatibus facilis earum, recusandae
          distinctio nostrum autem officiis suscipit, inventore vel.
          Praesentium vel saepe id minima quo sapiente cumque ex iure. Ex,
          nostrum rerum quos placeat saepe, cum in, harum aliquid vitae soluta
          minus dolorem rem sapiente dolorum at repudiandae consectetur nisi.
          Quas obcaecati, vero ipsa iure itaque sunt repellendus sit!Lorem
          ipsum dolor sit amet consectetur adipisicing elit. Magni non
          eligendi ipsam consequatur tempore deserunt quod illo? Quos
          distinctio nihil est nobis reprehenderit cumque iusto tenetur
          repellendus quod minus. Fugit! Ut corporis, modi saepe autem vel
          tempore quibusdam a sed facilis! Reiciendis, sint tenetur! Fugiat
          facilis quibusdam consequuntur itaque incidunt esse ea sunt
          reiciendis rerum beatae eaque totam, modi sint. Officiis ab quasi
          aut saepe veritatis quaerat enim nobis dolore sapiente, ipsa
          voluptates inventore suscipit reprehenderit cum, modi repellat a
          velit officia molestias? Explicabo est iste tenetur quod magnam
          mollitia!Lorem ipsum dolor sit amet consectetur adipisicing elit.
          Amet iure, ad eveniet eum laboriosam quae consequatur eaque
          doloremque corrupti similique fugiat magni quaerat eos non
          aspernatur, nesciunt aliquam voluptate tempore.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="slider" id="slider">
    ...
    <div class="slide" id="slide">
      <img class="item" src="media/images/a-b-image.jpg" />
      <img class="item" src="media/images/a-b-image.jpg" />
      <img class="item" src="media/images/a-b-image.jpg" />
      <img class="item" src="media/images/a-b-image.jpg" />
      <img class="item" src="media/images/a-b-image.jpg" />
